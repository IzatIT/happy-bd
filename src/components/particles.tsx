...
export const COLORS = {
    ...
    PRIMARY_COLOR: "rgba(53,53,181,0.96)",
    TRIOTERY_COLOR: "rgba(53,53,181,0.96)",
    SECONDARY_COLOR: "rgba(53,53,181,0.96)",
}

export const AppParticles = ({ color = COLORS.PRIMARY_COLOR }: Props) => {
